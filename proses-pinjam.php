...
if(isset($_POST['btnPinjam'])){
	...
	$id_petugas = 2;
	$sql = $stok = ambilStok($koneksi, $id_buku);

	if(cekPinjam($koneksi, $id_anggota) && $stok > 0){
		$res = mysqli_query($koneksi, "INSERT INTO peminjaman(id_anggota, tgl_pinjam, tgl_jatuh_tempo, id_petugas) VALUES('$id_anggota', '$tgl_pinjam', '$tgl_jatuh_tempo', '$id_petugas')");
