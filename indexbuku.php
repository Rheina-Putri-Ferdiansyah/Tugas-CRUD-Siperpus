...
<h2 class="card-title"><i class="far fa-edit"></i>data buku</h2>
  ...
  <center>
  <a href="tambahbuku.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">tambahdata</a>
  </center>
  <div class="card-body">
  <table class="table">
...
<a href="detail-buku.php?id_buku=<?= $p["id_buku"];?>" class="badge badge-success">detail</a>
